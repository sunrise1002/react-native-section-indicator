/**
 * Copyright (c) 2024 Damon Bauer
 * Source: https://github.com/damonbauer/react-native-get-item-layout-section-list
 * Modified by sunrise1002
 */
...
const getItemLayoutSectionList =
  <T>({
    getItemHeight,
...
export default getItemLayoutSectionList;
